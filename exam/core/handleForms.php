<?php
    ...
    if (isset($_POST['btn_Message_Applicant'])) {
        ...
        if (!empty($_POST['message'])) {
            ...
            $result = send_Message($pdo, $sender, $recipient, $message);
    ...
    if (isset($_POST['btn_Reply_Applicant'])) {
        ...
        if (!empty($_POST['reply'])) {
            ...
            $result = send_Message($pdo, $sender, $recipient, $reply);
            ...
            $_SESSION['status'] = "400";
            $_SESSION['message'] = "Missing info";
            header("Location: ../role_HR/reply_Messages.php?recipient=" . $_GET['recipient'] . "&msg_Replying_To=" . $_GET['msg_Replying_To']);
        }
    }
    ...
    if (isset($_POST['btn_Delete_HR_Reply'])) {
        ...
        $_SESSION['status'] = $result['status'];
        $_SESSION['message'] = $result['message'];
        header("Location: ../role_HR/replies.php");
    }
    ...
    if (isset($_POST['btn_Reply_HR'])) {
        ...
        if (!empty($_POST['reply'])) {
            ...
            $_SESSION['status'] = "400";
            $_SESSION['message'] = "Missing info";
            header("Location: ../role_Applicant/reply_Messages.php?recipient=" . $_GET['recipient'] . "&msg_Replying_To=" . $_GET['msg_Replying_To']);
        }
    }
    ...
    if (isset($_POST['btn_Delete_Applicant_Reply'])) {
        ...
        $_SESSION['status'] = $result['status'];
        $_SESSION['message'] = $result['message'];
        header("Location: ../role_Applicant/replies.php");
    }
