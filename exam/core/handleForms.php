<?php
    ...
    if (isset($_POST['btn_Respond_Application'])) {
        ...
        if (!empty($_POST['message'])) {
            ...
            $result = update_Application($pdo, $application_Status, $message, $applicant, $job_Title);

            $_SESSION['status'] = $result['status'];
            $_SESSION['message'] = $result['message'];
            header("Location: ../role_HR/view_Applications.php?job_Title=" . $_GET['job_Title'] . "&posted_By=" . $_GET['posted_By']);
    ...
    if (isset($_POST['btn_Message_Applicant'])) {
        ...
        if (!empty($_POST['message'])) {
            ...
            $_SESSION['status'] = $result['status'];
            $_SESSION['message'] = $result['message'];
            header("Location: ../role_HR/inbox.php");
    ...
    if (isset($_POST['btn_Reply_Applicant'])) {
        ...
        if (!empty($_POST['reply'])) {
            ...
            $_SESSION['status'] = $result['status'];
            $_SESSION['message'] = $result['message'];
            header("Location: ../role_HR/messages.php?sender=" . $_GET['recipient'] . "&msg_Subject=" . $_GET['msg_Subject']);
    ...
    if (isset($_POST['btn_Message_HR'])) {
        ...
        if (!empty($_POST['message'])) {
            ...
            $_SESSION['status'] = $result['status'];
            $_SESSION['message'] = $result['message'];
            header("Location: ../role_Applicant/inbox.php");
    ...
    if (isset($_POST['btn_Reply_HR'])) {
        ...
        if (!empty($_POST['reply'])) {
            ...
            $_SESSION['status'] = $result['status'];
            $_SESSION['message'] = $result['message'];
            header("Location: ../role_Applicant/messages.php?sender=" . $_GET['recipient'] . "&msg_Subject=" . $_GET['msg_Subject']);
