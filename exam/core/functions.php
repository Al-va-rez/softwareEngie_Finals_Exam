<?php
    ...
    function search_Messages_Sent($pdo, $searchQuery, $user) {
        $sql = "SELECT * FROM messages WHERE CONCAT(sender, message, date_Sent) COLLATE utf8mb4_bin LIKE ? AND sender = ?";
    ...
    function delete_Reply($pdo, $reply_id) {
        ...
        $activity_Log = log_Activity($pdo, "Deleted a reply", $job_To_Delete['title'], $_SESSION['username'], $_SESSION['role']);
