...
<html lang="en">
    ...
    <body class="hr">
        ...
        <div class="position_Center">
            ...
            <!-- MESSAGES -->
            <?php $HR_getAll_Messages = getAll_Messages_Received($pdo, $_SESSION['username']); ?>
            <?php if (count($HR_getAll_Messages) > 0) { ?>
                <table>
                    ...
                    <tbody>
                            ...
                            <?php foreach ($HR_getAll_Messages as $msg) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } ?>
                                        <a class="link_Btn" href="reply_Messages.php?recipient=<?= $msg['sender'] ?>&msg_Replying_To=<?= $msg['message'] ?>">Reply</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        ...
                        <!-- SEARCH -->
                        <?php } else { ?>
                            <?php $HR_search_Messages = search_Messages_Received($pdo, $_GET['inp_Search'], $_SESSION['username']); ?>
